        ...
        >
          ...
          <div className="pb-12 px-12 flex items-end justify-between">
            ...
            >
              ...
              >
                At Brightelv, Dubai, we design custom portable mixer racks and
                AV racks that keep your equipment organized, protected, and
                perfectly suited to your professional needs.{" "}
              </motion.p>
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <p className="text-gray-500 text-base leading-relaxed max-w-md">
                  Our portable mixer racks are designed to support various mixer
                  models and sizes, offering ergonomic access to controls,
                  robust construction for frequent transport, and customizable
                  options such as rack height, depth, and additional storage to
                  suit your workflow.
                </p>
                <p className="text-gray-500 text-base leading-relaxed max-w-md">
                  Our AV racks provide a flexible and secure solution for
                  audio-visual equipment, featuring a modular design for easy
                  expansion, efficient cable management for a clean setup, and
                  proper ventilation to ensure optimal performance and prevent
                  overheating.
                </p>
              </motion.div>
            </div>
