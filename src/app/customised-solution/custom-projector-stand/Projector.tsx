        ...
        >
          ...
          <div className="pb-12 px-12 flex items-end justify-between">
            ...
            >
              ...
              >
                At Brightelv, Dubai’s premier provider of custom projector stands and ceiling mounts. At Brightelv, we understand the importance of precise, reliable, and aesthetically pleasing projector installations for both residential and commercial spaces. Our mission is to offer bespoke solutions that perfectly match your unique requirements, ensuring optimal performance and a seamless integration with your environment.
              </motion.p>
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <p className="text-gray-500 text-base leading-relaxed max-w-md">
                  At Brightelv, our custom flight cases are precision-built to
                  protect your valuable equipment during transport, featuring
                  tailored designs for a perfect fit, durable high-quality
                  materials for maximum protection, and smart features like
                  custom foam inserts, reinforced corners, secure locks, and
                  easy-carry handles.
                </p>
                <p className="text-gray-500 text-base leading-relaxed max-w-md">
                  Our wooden podiums combine refined design with practical
                  functionality, featuring bespoke styles to suit your venue,
                  premium craftsmanship for durability, and integrated options
                  such as microphones, lighting, adjustable heights, and
                  convenient storage.{" "}
                </p>
              </motion.div>
