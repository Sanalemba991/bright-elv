  ...
  const features = [
    {
      ...
      description:
        "Intelligent call routing system that directs calls to the right departments and personnel, ensuring efficient communication flow throughout your organization.",
    },
    {
      icon: <Headphones className="w-6 h-6" />,
      title: "Advanced Voicemail",
      description:
        "Comprehensive voicemail system with message forwarding, transcription, and notification features to ensure you never miss important communications.",
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Call Conferencing",
      description:
        "Multi-party conferencing capabilities that enable seamless collaboration and communication between teams, departments, and external stakeholders.",
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Secure & Reliable",
      description:
        "Enterprise-grade security features and reliable connectivity ensure your business communications remain protected and always operational.",
    },
  ];
    ...
    <>
        ...
        >
          ...
          <div className="pb-12 px-12 flex items-end justify-between">
            ...
            >
              ...
              >
                State-of-the-art PABX (Private Automated Branch Exchange)
                solutions designed to streamline your communication needs with
                seamless internal and external connectivity for businesses of
                all sizes.
              </motion.p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-start">
              ...
              >
                ...
                >
                  Powerful Communication Amplification
                </motion.h3>
      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto">
          {/* Section 01 & Image - High-Resolution Audio */}
          ...
          {/* Section 02 & 03 - Voice Control & Secure Connections */}
